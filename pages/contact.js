...
export default function () {
    return (
        <m.main
            ...
            <div className='mt-56 mb-44 p-1 overflow-hidden'>
                <m.h1
                    animate={{y: 0}}
                    initial={{y: '100%'}}
                    transition={{delay: 0.5, duration: 0.5}}
                    className='text-6xl text-center lg:text-9xl lg:text-right lg: text-9xl'>Let's Talk
                </m.h1>
            </div>
            <div className='flex gap-40 '>
                ...
                <div className='lg:text-3xl text-2xl underline'>
